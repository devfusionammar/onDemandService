  ...
  return (
    <ScreenWrapper>
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        <View style={{ flexDirection: 'row', marginTop: Rh(4), borderStyle: 'dashed', borderColor: colors.font1, borderWidth: Rw(0.4),
         height: Rh(10), width: Rw(60), marginHorizontal: Rw(21), borderTopRightRadius: Rw(5), borderBottomRightRadius: Rw(5), overflow:'hidden'}}>
          <View>
